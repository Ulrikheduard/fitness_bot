...
# Пример набора цитат
QUOTES = [
    "Делай как умеешь. Лучше не выйдет.",
    "Мысли есть, смысла нет.",
    "Не жди мотивации. Её никто не собирался присылать.",
    "Просыпайся, чемпион… по откладыванию всего на потом.",
    "Утро доброе — но не для тебя. Делай отжимания.",
    "Лень — это талант. Но давай сделаем вид, что мы против.",
    "Первое правило успеха: начни. Хотя бы сделай вид.",
    "Если хочешь быть сильным — будь. А если нет — тоже будь, просто слабым.",
    "Сегодня ты можешь всё. Но начни хотя бы с одного подхода.",
    "С каждым отжиманием ты становишься лучше. Но очень медленно, не обольщайся.",
    "Если устал — отдохни. Если не устал — всё равно отдохни.",
    "Отжимания не решат проблемы, но дадут время не думать о них.",
    "У тебя нет времени? Отлично, сделай быстро.",
    "Идеальный момент? Он не существует. Делай сейчас.",
    "Не хочешь? Понимаю. Но всё равно делай.",
    "Будущее в твоих руках. Но сначала пусть руки выдержат твоё тело.",
    "Ты можешь больше, чем тебе лень.",
    "Слабость — это когда не можешь. Лень — когда не хочешь. Угадай, что у тебя?",
    "Сделай отжимания. Мир не станет лучше, но ты — да. Чутка.",
    "Мотивация придёт. После отжиманий. Возможно.",
    "Не будь слабым. Это место уже занято.",
    "Если мир давит — отожмись и дай ему сдачи.",
    "Бойся не падений, а того, что так и не поднимешься.",
    "Нет плохих дней. Есть дни, когда ты не сделал подход.",
    "Не хочешь? Отлично. Значит, именно сегодня и нужно.",
    "Иногда прогресс — это просто «я всё же сделал».",
    "Если не можешь — сделай. Если можешь — сделай дважды.",
    "Ты не обязан быть уверенным. Ты обязан действовать.",
    "Лежишь? Отлично. Ты на старте.",
    "Твоё будущее не обидится, если ты ничего не сделаешь. Оно просто будет таким же унылым.",
    "Судьба любит смелых. А пока она тебя жалеет.",
    "Прокрастинация — это тоже работа. Но в минус.",
    "Ты лучше, чем был вчера. Но это была низкая планка.",
    "Каждый раз, когда ты сдаёшься, твоя лень получает +1 к уровню.",
    "Если заниматься собой неприятно — значит, давно пора.",
    "Мир несправедлив. Но в отжиманиях хотя бы есть правила.",
